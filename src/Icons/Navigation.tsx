...
export const NavigationIcon = ({
  ...
  return (
    <svg
      ...
      className={classnames("navigation-icon", className)}
      {...rest}>
      ...
      <path d="M8.6095 8.46721C8.37019 8.34755 8.26749 8.06071 8.37646 7.81635L10.5271 2.99379C11.1174 1.67004 12.8818 1.67004 13.4722 2.99379L17.4401 11.8915C17.6313 12.3202 17.1797 12.7523 16.7598 12.5424L8.6095 8.46721Z" />
      {children}
    </svg>
  );
};
