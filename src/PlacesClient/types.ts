...
export interface paths {
  "/v1/places/{place}": {
    ...
    get: operations["Places_GetPlace"];
    put?: never;
    post?: never;
    delete?: never;
    options?: never;
  ...
  "/v1/places/{place}/photos/{photo}/media": {
    ...
    get: operations["Places_GetPhotoMedia"];
    put?: never;
    post?: never;
    delete?: never;
    options?: never;
  ...
  "/v1/places:autocomplete": {
    ...
    post: operations["Places_AutocompletePlaces"];
    delete?: never;
    options?: never;
    head?: never;
    patch?: never;
  ...
  "/v1/places:searchNearby": {
    ...
    post: operations["Places_SearchNearby"];
    delete?: never;
    options?: never;
    head?: never;
    patch?: never;
  ...
  "/v1/places:searchText": {
    ...
    post: operations["Places_SearchText"];
    delete?: never;
    options?: never;
    head?: never;
    patch?: never;
...
export interface components {
  schemas: {
    ...
    AutocompletePlacesRequest: {
       ...
       *      signal. */
      locationBias?: components["schemas"]["AutocompletePlacesRequest_LocationBias"];
       ...
       *      address will be mapped to an imprecise location and used as a biasing
       *      signal. */
      locationRestriction?: components["schemas"]["AutocompletePlacesRequest_LocationRestriction"];
    ...
    AutocompletePlacesRequest_LocationBias: {
      ...
      rectangle?: components["schemas"]["Viewport"];
    ...
    AutocompletePlacesResponse: {
      ...
      suggestions?: components["schemas"]["AutocompletePlacesResponse_Suggestion"][];
    };
    /** @description An Autocomplete suggestion result. */
    AutocompletePlacesResponse_Suggestion: {
      /** @description A prediction for a Place. */
      placePrediction?: components["schemas"]["Suggestion_PlacePrediction"];
      /** @description A prediction for a query. */
      queryPrediction?: components["schemas"]["Suggestion_QueryPrediction"];
    };
    ...
    ContextualContent: {
      ...
      justifications?: components["schemas"]["ContextualContent_Justification"][];
    };
    /** @description Experimental: See
     *      https://developers.google.com/maps/documentation/places/web-service/experimental/places-generative
     *      for more details.
    ...
    ContextualContent_Justification: {
       ...
       *      https://developers.google.com/maps/documentation/places/web-service/experimental/places-generative
       *      for more details. */
      reviewJustification?: components["schemas"]["Justification_ReviewJustification"];
      /** @description Experimental: See
       *      https://developers.google.com/maps/documentation/places/web-service/experimental/places-generative
       *      for more details. */
      businessAvailabilityAttributesJustification?: components["schemas"]["Justification_BusinessAvailabilityAttributesJustification"];
    };
    ...
    EVChargeOptions: {
      ...
      connectorAggregation?: components["schemas"]["EVChargeOptions_ConnectorAggregation"][];
    };
    ...
    FuelOptions: {
      ...
      fuelPrices?: components["schemas"]["FuelOptions_FuelPrice"][];
    };
    ...
    Justification_ReviewJustification: {
      highlightedText?: components["schemas"]["ReviewJustification_HighlightedText"];
    ...
    OpeningHours_Period: {
      ...
      open?: components["schemas"]["Period_Point"];
      /** @description The time that the place starts to be closed. */
      close?: components["schemas"]["Period_Point"];
    };
    ...
    Place: {
       ...
       *      B at
       *      https://developers.google.com/maps/documentation/places/web-service/place-types */
      primaryTypeDisplayName?: components["schemas"]["LocalizedText"];
      ...
      addressComponents?: components["schemas"]["Place_AddressComponent"][];
      /** @description Plus code of the place location lat/long. */
      plusCode?: components["schemas"]["Place_PlusCode"];
      ...
      attributions?: components["schemas"]["Place_Attribution"][];
      /**
       * Format: int32
      ...
      currentOpeningHours?: components["schemas"]["Place_OpeningHours"];
      ...
      currentSecondaryOpeningHours?: components["schemas"]["Place_OpeningHours"][];
      ...
      regularSecondaryOpeningHours?: components["schemas"]["Place_OpeningHours"][];
      ...
      editorialSummary?: components["schemas"]["LocalizedText"];
      ...
      paymentOptions?: components["schemas"]["Place_PaymentOptions"];
      /** @description Options of parking provided by the place. */
      parkingOptions?: components["schemas"]["Place_ParkingOptions"];
      /** @description A list of sub destinations related to the place. */
      subDestinations?: components["schemas"]["Place_SubDestination"][];
      /** @description Information about the accessibility options a place offers. */
      accessibilityOptions?: components["schemas"]["Place_AccessibilityOptions"];
      /** @description The most recent information about fuel options in a gas station. This
       *      information is updated regularly. */
      fuelOptions?: components["schemas"]["FuelOptions"];
      /** @description Information of ev charging options. */
      evChargeOptions?: components["schemas"]["EVChargeOptions"];
      /** @description Experimental: See
       *      https://developers.google.com/maps/documentation/places/web-service/experimental/places-generative
       *      for more details.
       *
       *      AI-generated summary of the place. */
      generativeSummary?: components["schemas"]["Place_GenerativeSummary"];
      /** @description Experimental: See
       *      https://developers.google.com/maps/documentation/places/web-service/experimental/places-generative
       *      for more details.
       *
       *      AI-generated summary of the area that the place is in. */
      areaSummary?: components["schemas"]["Place_AreaSummary"];
    };
    /** @description Information about the accessibility options a place offers. */
    ...
    Place_GenerativeSummary: {
      ...
      overview?: components["schemas"]["LocalizedText"];
    ...
    Place_OpeningHours: {
      ...
      periods?: components["schemas"]["OpeningHours_Period"][];
       ...
       *      exceptional hours. */
      specialDays?: components["schemas"]["OpeningHours_SpecialDay"][];
    };
    ...
    Review: {
      ...
      originalText?: components["schemas"]["LocalizedText"];
      /**
       * Format: double
      ...
      authorAttribution?: components["schemas"]["AuthorAttribution"];
      /**
       * Format: date-time
    ...
    ReviewJustification_HighlightedText: {
      ...
      highlightedTextRanges?: components["schemas"]["HighlightedText_HighlightedTextRange"][];
    };
    ...
    SearchTextRequest: {
      ...
      locationBias?: components["schemas"]["SearchTextRequest_LocationBias"];
       ...
       *      with location_bias. */
      locationRestriction?: components["schemas"]["SearchTextRequest_LocationRestriction"];
      /** @description Optional. Set the searchable EV options of a place search request. */
      evOptions?: components["schemas"]["SearchTextRequest_EVOptions"];
    };
    ...
    SearchTextResponse: {
      ...
      contextualContents?: components["schemas"]["ContextualContent"][];
    };
    ...
    Suggestion_FormattableText: {
      ...
      matches?: components["schemas"]["Suggestion_StringRange"][];
    };
    ...
    Suggestion_PlacePrediction: {
      ...
      text?: components["schemas"]["Suggestion_FormattableText"];
       ...
       *      different ways to represent a Place prediction. Users should not try to
       *      parse `structured_format` into `text` or vice versa. */
      structuredFormat?: components["schemas"]["Suggestion_StructuredFormat"];
    ...
    Suggestion_StructuredFormat: {
      ...
      mainText?: components["schemas"]["Suggestion_FormattableText"];
      ...
      secondaryText?: components["schemas"]["Suggestion_FormattableText"];
    };
    ...
    Viewport: {
      ...
      low?: components["schemas"]["LatLng"];
      /** @description Required. The high point of the viewport. */
      high?: components["schemas"]["LatLng"];
    };
  };
  responses: never;
  parameters: never;
...
export interface operations {
  ...
  Places_GetPhotoMedia: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          "application/json": components["schemas"]["PhotoMedia"];
        };
      };
      /** @description Default error response */
      default: {
  ...
  Places_AutocompletePlaces: {
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["AutocompletePlacesRequest"];
      };
    };
    responses: {
      /** @description OK */
      200: {
        ...
        content: {
          "application/json": components["schemas"]["AutocompletePlacesResponse"];
        };
      };
      /** @description Default error response */
      default: {
  ...
  Places_SearchNearby: {
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["SearchNearbyRequest"];
      };
    };
    responses: {
      /** @description OK */
      200: {
        ...
        content: {
          "application/json": components["schemas"]["SearchNearbyResponse"];
        };
      };
      /** @description Default error response */
      default: {
  ...
  Places_SearchText: {
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["SearchTextRequest"];
      };
    };
    responses: {
      /** @description OK */
      200: {
        ...
        content: {
          "application/json": components["schemas"]["SearchTextResponse"];
        };
      };
      /** @description Default error response */
      default: {
